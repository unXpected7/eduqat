        ...
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div className="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
            <button
              ...
              disabled={sessionData.material?.length === 0}
              className="text-white disabled:bg-gray-300 bg-purple-700 hover:bg-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center "
            >
              Save
            </button>
            <button
...
export default AddLessonMaterial;